...
export class SigninFormComponent {
  ...
  constructor(databseService:DatabaseService) {
    this.databaseService = databseService;
  ...
  public login(){
    // this.databaseService.signIn(this.loginFormGroup.controls.email.value, this.loginFormGroup.controls.password.value).subscribe(
    //   data =>{
    //     console.log(data);
    //   }
    // );
